            ...
            <div class="col-md-6 col-lg-5">
                <div class="tarjeta-custom p-4 border-top border-4 border-warning">
                    ...
                    <form action="editar.php" method="POST">
                        <div class="mb-3">
                            <label class="form-label text-muted small">Título</label>
                            <input type="text" name="titulo" class="form-control" value="Ejemplo" required>
                        </div>
                        <div class="mb-3">
                            <label class="form-label text-muted small">Descripción</label>
                            <textarea name="descripcion" class="form-control" rows="3" required>Detalle de ejemplo</textarea>
                        </div>
                        <div class="mb-4">
                            <label class="form-label text-muted small">Prioridad</label>
                            <select name="prioridad" class="form-select" required>
